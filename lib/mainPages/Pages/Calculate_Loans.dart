...
import 'package:moneyapp_speed_code/mainPages/Pages/Credit_score.dart';

class Calculate_Loans extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // navigation to new screen
    void navigateToCredit_score() {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => Credit_score()));
    }
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            //Build Button
            BottomButton(
              buttonPressed: navigateToCredit_score,
